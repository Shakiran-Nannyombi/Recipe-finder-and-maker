        ...
        <div className="min-h-screen bg-background-light font-body overflow-x-hidden">
            ...
            <header className="relative pt-20 pb-32 px-8 overflow-hidden">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="relative z-10 space-y-8 will-change-transform animate-fadeIn">
                    ...
                    <div className="relative will-change-transform animate-fadeInRight" style={{ animationDelay: '0.1s' }}>
                        <div className="relative rounded-[2rem] overflow-hidden shadow-2xl shadow-primary/20 border-8 border-white group">
                            <img
                                src="https://images.unsplash.com/photo-1547592166-23ac45744acd?auto=format&fit=crop&q=60&w=1000"
            ...
            <section id="features" className="py-24 px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center space-y-4 mb-20 text-pretty">
            ...
            <section className="py-24 px-8">
                <div className="max-w-5xl mx-auto rounded-[3rem] bg-slate-900 p-16 relative overflow-hidden text-center space-y-8">
